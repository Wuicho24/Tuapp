            ...
            withContext(Dispatchers.IO) {
                try {
                    ...
                    val silabasPorPalabraNivel4 = mapOf(
                        ...
                        "informacion" to listOf("in", "for", "ma", "ción"),
                        "tecnología" to listOf("tec", "no", "lo", "gía"),
                        "investigacion" to listOf("in", "ves", "ti", "ga", "ción"),
                        ...
                        "celebracion" to listOf("ce", "le", "bra", "ción"),
                        "imaginacion" to listOf("i", "ma", "gi", "na", "ción"),
